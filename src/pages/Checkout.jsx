...
const Checkout = () => {
  ...
  for (let count = 1;count <= dataPost.price.adult_count; count++) {
    elementAdult.push(<div className="dataPenumpang">
      ...
      <Card.Body>
        <Form>
          <Form.Group className="mb-3">
            ...
            <Form.Control type="text" onChange={(e)=>{handleChange(e,count-1)}} />
          </Form.Group>
          ...
          <Form.Group className="mb-3">
            ...
            <Form.Control type="text" onChange={(e)=>{handleChangeName(e,count-1)}}/>
          ...
          <Form.Group className="mb-3">
            ...
            <Form.Control type="date" onChange={(e)=>{handleChangeDate(e,count-1)}} />
          </Form.Group>
          ...
          <Form.Group className="mb-3">
            ...
            <Form.Control type="text"onChange={(e)=>{handleChangeNational(e,count-1)}} />
          </Form.Group>
          ...
          <Form.Group className="mb-3">
            ...
            <Form.Control type="text" onChange={(e)=>{handleChangeKtp(e,count-1)}}/>
          </Form.Group>
  ...
  for (let count = 1;count <= dataPost.price.child_count; count++) {
    elementKid.push(<div className="dataPenumpang">
    <Card className="border-0">
      <Card.Header className="bg-dark text-light">
      ...
      <Card.Body>
        <Form>
          <Form.Group className="mb-3">
            ...
            <Form.Control type="text" onChange={(e)=>{handleChangeKid(e,count-1)}}/>
          </Form.Group>
          ...
          <Form.Group className="mb-3">
            ...
            <Form.Control type="text" onChange={(e)=>{handleChangeNameKid(e,count-1)}} />
            <div className="d-flex justify-content-between align-items-center mt-2">
              <Form.Text>Punya Nama Keluarga?</Form.Text>
              <Form.Check
                type="switch"
          ...
          <Form.Group className="mb-3">
            ...
            <Form.Control type="date" onChange={(e)=>{handleChangeDateKid(e,count-1)}} />
          </Form.Group>
          ...
          <Form.Group className="mb-3">
            ...
            <Form.Control type="text" onChange={(e)=>{handleChangeNationalKid(e,count-1)}} />
          </Form.Group>
          <Form.Group className="mb-3">
            <Form.Label className="fw-bold" style={{ color: "#7126b5" }}>
              KTP/NIK
            </Form.Label>
            <Form.Control type="text" onChange={(e)=>{handleChangeKtpKid(e,count-1)}}/>
          </Form.Group>
        </Form>
      </Card.Body>
    </Card>
  ...
  for (let count = 1;count <= dataPost.price.infant_count; count++) {
    elementinfant.push(<div className="dataPenumpang">
    <Card className="border-0">
      <Card.Header className="bg-dark text-light">
      ...
      <Card.Body>
        <Form>
          <Form.Group className="mb-3">
            ...
            <Form.Control type="text" onChange={(e)=>{handleChangeInf(e,count-1)}} />
          </Form.Group>
          ...
          <Form.Group className="mb-3">
            ...
            <Form.Control type="text" onChange={(e)=>{handleChangeNameInf(e,count-1)}}/>
            <div className="d-flex justify-content-between align-items-center mt-2">
              <Form.Text>Punya Nama Keluarga?</Form.Text>
              <Form.Check
                type="switch"
          ...
          <Form.Group className="mb-3">
            ...
            <Form.Control type="date" onChange={(e)=>{handleChangeDateInf(e,count-1)}} />
          </Form.Group>
          ...
          <Form.Group className="mb-3">
            ...
            <Form.Control type="text"  onChange={(e)=>{handleChangeNationalInf(e,count-1)}}/>
          </Form.Group>
          <Form.Group className="mb-3">
            <Form.Label className="fw-bold" style={{ color: "#7126b5" }}>
              NIK
            </Form.Label>
            <Form.Control type="text" onChange={(e)=>{handleChangeKtpInf(e,count-1)}}/>
          </Form.Group>
        </Form>
      </Card.Body>
    </Card>
  ...
  function handleCreateOrder(e) {
    ...
    axios.post('https://tiketku-development.up.railway.app/order',order,{
      headers: {
